...
public class CRUDChamado extends Conexao implements CRUD<Chamado> {
	...
	public String registrar(Chamado obj) {
		...
		try {
			...
			if (i > 0) {
				...
				txt = "Não foi possivel realizar o chamado.";
			}
	...
	public List<Chamado> listar() {
		...
		try {
			 ...
			 * retorno do executeQuery é um ResulSet, portanto é necessário que haja uma
			 * variavael do tipo ResultSet para guardar o retorno da execução. Estamos
			 * usando a variavl que foi declarada na classe Conexao
			 */
